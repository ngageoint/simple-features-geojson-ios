...
+(SFMultiPolygon *) multiPolygonWithRings{
    ...
    [points addObject:[[SFPoint alloc] initWithXValue:-100.1 andYValue:-50.3]];
    [points addObject:[[SFPoint alloc] initWithXValue:100 andYValue:-50]];
    [points addObject:[[SFPoint alloc] initWithXValue:1.5 andYValue:50.6]];
    ...
    [points addObject:[[SFPoint alloc] initWithXValue:50.7 andYValue:-25.9]];
