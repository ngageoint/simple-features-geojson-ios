...
-(void) testSerializeFeature2{
    ...
    NSString *json = @"{\"type\":\"Feature\",\"geometry\":{\"type\":\"MultiPolygon\",\"coordinates\":[[[[-100,-50],[100,-50],[1.5,50],[-100,-50]],[[-50,-25],[50,-25],[-1,25],[-50,-25]]]]},\"properties\":{\"foo\":\"bar\"}}";
...
-(void) compareFeature: (SFGFeature *) feature withJSON: (NSString *) json{
    ...
    if([treeFromJSON objectForKey:SFG_MEMBER_PROPERTIES] == nil){
        [treeFromJSON setObject:[NSMutableDictionary dictionary] forKey:SFG_MEMBER_PROPERTIES];
    }
